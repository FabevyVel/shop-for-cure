...
<div class="container">
    ...
    <form:form modelAttribute="searchContent">
        <h2 class="mb-0 mt-5"><small>Search results for herb: </small><strong>${searchContent.searchTerm}</strong></h2>
        <br>
    </form:form>
    <form:form method="post" action="searchInfo" modelAttribute="herbList">
        <div class="row">
            <c:forEach items="${herbList}" var="herb" varStatus="status">
                    ...
                    <form:form method="get" action="get-info" modelAttribute="searchContent">
                        <div class="card h-100">
                            ...
                            <div class="card-footer">
                                <a href="get-info?searchTerm=${herb.herbName}&category=${searchContent.category}">
